...
There is no (as far as I know) a good solution in R for geting data from Raster pictures. That make complicated work with old maps.
...
>- Multiple features requere a database...
>- that allow to work with complex query...
>- Methods for dimention reduction (PCA/MCA, MDS, etc.) allow to cluster features and define the interesting one
>- But anyway it is linguists who need to decide whether feature or feature combination is *ineteresting* or not.
...
>     - Getis-Ord G~i* (@ord95). This measure tests for local spatial autocorrelation, which asks whether each location is part of a significant high or low value cluster with its neighbors.
...
>- Te open Science and standards for linguistic mapping will make
>       - our life easear
>       - our researchs more comparable
